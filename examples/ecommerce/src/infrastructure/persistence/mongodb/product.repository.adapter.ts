...
import { ProductRepository as IProductRepository } from '../../../components/order/application/repositories/product.repository'
...
export class ProductRepositoryAdapter extends MongoDbRepositoryAdapter<Product> implements IProductRepository {
