...
import { OrderCreatedEvent } from '../src/components/order/domain/events/order-created.event'
import { PinoLoggerAdapter } from '../src/infrastructure/logging/pino-logger.adapter'
...
app.eventPublisher
  .listen<OrderCreatedEvent>('order-created', async event => {
    logger.debug(
